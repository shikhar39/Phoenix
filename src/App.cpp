...
void App::drawFrame() {
  ...
  VkResult result = vkAcquireNextImageKHR(
      *device.get(), *device.getSwapchain(), UINT64_MAX,
      device.getImageAvailableSemaphore(currentFrame), nullptr, &imageIndex);
  ...
  VkSemaphore signalSemaphores[] = {
      device.getRenderFinishedSemaphore(currentFrame)};
