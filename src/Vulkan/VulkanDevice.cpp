...
QueueFamilyIndices
Device::findQueueFamilies(const VkPhysicalDevice &device) const {
...
Device::checkSwapchainSupport(const VkPhysicalDevice &device) {
...
Device::~Device() {
  spdlog::warn("Figure out what resources are destroyed on their own and what "
